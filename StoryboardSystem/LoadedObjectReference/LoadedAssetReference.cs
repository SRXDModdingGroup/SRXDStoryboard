...
internal abstract class LoadedAssetReference : LoadedObjectReference {
    ...
    public abstract LoadedInstanceReference CreateInstanceReference(string name, int sceneRootIndex, int layer);
...
internal class LoadedAssetReference<T> : LoadedAssetReference where T : Object {
    ...
    public override LoadedInstanceReference CreateInstanceReference(string name, int sceneRootIndex, int layer) => new LoadedInstanceReference<T>(this, name, sceneRootIndex, layer);
}