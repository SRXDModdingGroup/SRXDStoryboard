...
public struct FrameData {
    ...
    public FrameData() {
        ...
        SequenceTime = 0d;
        SequenceRepeat = 1;
        InterpType = InterpType.Fixed;
    }

    public FrameData(int first, int clusterCount, int clusterStep, int sequenceCount, int sequenceStep, SequenceTimeType sequenceTimeType, double sequenceTime, int sequenceRepeat, InterpType interpType) {
        First = first;
